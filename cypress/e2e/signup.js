...
describe('View Crud', () => {
    ...
    it('TC9 - Can delete one Crud', () => {
        //Delete Crud 'NAB Innovation Centre Vietnam' 
        cy.get(':nth-child(6) > :nth-child(7) > .btn').click()
        cy.url().should('include', 'http://localhost:3000/cruds/64489b1e27daca886fe66a2d/delete')
        cy.get('h2').contains('NAB Innovation Centre Vietnam')
        cy.get(':nth-child(7) > small').contains('ID: 64489b1e27daca886fe66a2d')
        cy.get('.btn-danger').click()
        cy.url().should('include', 'http://localhost:3000/cruds')
